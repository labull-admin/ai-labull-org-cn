          ...
          child: Column(children: [
            ...
            Row(
              ...
              children: [
                ...
                Checkbox(
                    value: _imageGenerationSettings.ifRevisePrompt,
                    onChanged: (value) {
                      setState(() {
                        _imageGenerationSettings.ifRevisePrompt = value!;
                        print("settings if revised prompt:");
                        print(_imageGenerationSettings);
                      });
                      BlocProvider.of<ImageGenerationBloc>(context).add(
                          ImageGenerationSettingsChange(
                              imageGenerationSettings:
                                  _imageGenerationSettings));
                    }),
              ],
            )
          ]),
