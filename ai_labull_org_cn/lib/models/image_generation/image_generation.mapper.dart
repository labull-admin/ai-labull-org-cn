...
class ImageGenerationMapper extends ClassMapperBase<ImageGeneration> {
  ...
  static bool _$ifRevisePrompt(ImageGeneration v) => v.ifRevisePrompt;
  static const Field<ImageGeneration, bool> _f$ifRevisePrompt =
      Field('ifRevisePrompt', _$ifRevisePrompt);
