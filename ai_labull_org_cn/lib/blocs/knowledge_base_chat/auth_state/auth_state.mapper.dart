...
class AuthStateNotLogedInMapper extends ClassMapperBase<AuthStateNotLogedIn> {
  ...
  @override
  final MappableFields<AuthStateNotLogedIn> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
...
class AuthStateLogedInMapper extends ClassMapperBase<AuthStateLogedIn> {
  ...
  @override
  final MappableFields<AuthStateLogedIn> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
...
class AuthStateLoginInitialMapper
  ...
  @override
  final MappableFields<AuthStateLoginInitial> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
  ...
  static AuthStateLoginInitial _instantiate(DecodingData data) {
    return AuthStateLoginInitial(stateType: data.dec(_f$stateType));
  }
...
class AuthStateLoginLoadingMapper
  ...
  @override
  final MappableFields<AuthStateLoginLoading> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
...
class AuthStateLoginSuccessMapper
  ...
  @override
  final MappableFields<AuthStateLoginSuccess> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
...
class AuthStateLoginFailureMapper
  ...
  @override
  final MappableFields<AuthStateLoginFailure> fields = const {
    #stateType: _f$stateType,
    #error: _f$error,
    #user: _f$user,
  };
...
class AuthStateLogoutInitialMapper
  ...
  @override
  final MappableFields<AuthStateLogoutInitial> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
...
class AuthStateLogoutLoadingMapper
  ...
  @override
  final MappableFields<AuthStateLogoutLoading> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
...
class AuthStateLogoutSuccessMapper
  ...
  @override
  final MappableFields<AuthStateLogoutSuccess> fields = const {
    #stateType: _f$stateType,
    #user: _f$user,
    #error: _f$error,
  };
...
class AuthStateLogoutFailureMapper
  ...
  @override
  final MappableFields<AuthStateLogoutFailure> fields = const {
    #stateType: _f$stateType,
    #error: _f$error,
    #user: _f$user,
  };
